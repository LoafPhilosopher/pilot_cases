    ...
    if successor == null {
        ...
        ensures values[i] == View[|View| - 1 - i]
      {
        if i < |rest| {
          ...
          assert 0 <= |next.View| - 1 - i < |next.View|;
          assert rest[i] == next.View[|next.View| - 1 - i];
          assert values[i] == rest[i];
          assert |View| == 1 + |next.View|;
          assert |View| - 1 - i ==
            1 + (|next.View| - 1 - i);
          assert View[|View| - 1 - i] ==
            next.View[|next.View| - 1 - i];
        } else {
          assert |values| == |rest| + 1;
          assert i == |rest|;
          assert |rest| == |next.View|;
          assert |View| == 1 + |next.View|;
          assert |View| - 1 - i == 0;

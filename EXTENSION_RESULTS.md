...
| [010](case_010_in_place_chain_reversal/REPORT.md) | ID308, transform a linked chain | 17 resolution/type errors | **Gate not entered.** The candidate used the nonexistent sequence member `.Length`. No repair was requested during the original extension. In the later repair study, Round 01 passed; see the Case 010 report. |
